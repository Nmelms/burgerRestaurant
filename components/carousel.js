...
<div style="border-radius: 10px; width: 100%" id="carouselExampleControls" class="d-none d-md-flex justify-content-center carousel  bg-dark slide my-5 " data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img style="margin: 0 auto; max-width:80%; object-fit: contain" src="./assets/caro1.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img style="margin: 0 auto; max-width:80%; object-fit: contain" src="./assets/caro2.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img  style="margin: 0 auto; max-width:80%; object-fit: contain" src="./assets/caro3.jpg" class="d-block w-100" alt="...">
    </div>
  </div>
